...
module.exports = class MyBrandOAuth2Client extends OAuth2Client {
  ...
  static REGION_DOMAIN = 'isolarcloud.eu';

  static REDIRECT_URL = 'https://callback.athom.com/oauth2/callback/';
  static API_URL = `https://gateway.${this.REGION_DOMAIN}`;
  static TOKEN_URL = `${this.API_URL}/openapi/apiManage/token`;
  static REFRESH_URL = `${this.API_URL}/openapi/apiManage/refreshToken`;
  ...
  // static AUTHORIZATION_URL = `https://web3.${this.REGION_DOMAIN}/#/authorized-app?cloudId=${this.CLOUD_ID}&applicationId=${this.APPLICATION_ID}&redirectUrl=${this}`;
